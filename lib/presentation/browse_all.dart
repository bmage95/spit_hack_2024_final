              ...
              child: GridView.builder(
                ...
                itemBuilder: (context, index) {
                  return Column(
                    ...
                    children: [
                      // Check if the index is within the range of imagePaths
                      if (index < _imagePaths.length)
                        Image.asset(
                          _getImagePath(index), // Get the corresponding image path
                          height: 60,
                          width: 60,
                        )
                      else
                        Icon(
                          _icons[index - _imagePaths.length], // Adjust index for icons list
                          size: 40,
                        ),
